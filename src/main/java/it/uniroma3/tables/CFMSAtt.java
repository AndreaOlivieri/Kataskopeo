...
public class CFMSAtt extends Table {
	...
	protected String sqlTable() {
		return "SELECT NUMERO,"
		           + " DATA_ATTIVAZIONE, CONCAT(COD_PDV, ' ', COD_DEALER), LUOGO_NASCITA, DATA_NASCITA, NUMERO_DOCUMENTO, INDIRIZZO_RESIDENZA, COMUNE_RESIDENZA, CAP_RESIDENZA "
		    + " FROM Kataskopeo_hash.CFMS_ATT"+ LIMIT_ROWS;
	}
