...
public class Device extends Table {
	...
	private static int[] indexOccuranceSecondaryVertexClass = {  18,                                            14,                            2,                              3,                          5,                              3,                                                14,                         2,                           3,                     5,                        3           };  
	private static String[] nameEdgesSecondaryVertexClass =   {"IMEI", "CODICE_DEALER_INGRESSO", "RAGIONE_SOCIALE_DEALER_INGRESSO", "INDIRIZZO_DEALER_INGRESSO", "LOCALITA_DEALER_INGRESSO", "PROVINCIA_DEALER_INGRESSO", "COMUNE_DEALER_INGRESSO", "CODICE_DEALER_USCITA", "RAGIONE_SOCIALE_DEALER_USCITA", "INDIRIZZO_DEALER_USCITA", "LOCALITA_DEALER_USCITA", "PROVINCIA_DEALER_USCITA", "COMUNE_DEALER_USCITA" };
	...
	protected String sqlTable() {
		return "SELECT IMEI, I_DESTINATARIO_MERCI, I_RAG_SOCIALE, I_INDIRIZZO, I_LOC, I_PR, I_COMUNE, O_DESTINATARIO_MERCI, O_RAG_SOCIALE, O_INDIRIZZO, O_LOC, O_PR, O_COMUNE "
