...
public class TestataDWI extends Table {
	...
	protected String sqlTable() {
		return "SELECT TO_V_COD_ROWID_ORD,"
				+ " TO_V_COD_NUM_ORD, TO_V_COD_ROWID_CLI, TO_V_COD_ACLI_CLI, TO_V_COD_PAR_IVA_CLI, TO_V_COD_RAG_SOC_CLI, TO_V_COD_NUM_DOC_CLI, TO_V_COD_NUM_CNT, TO_V_COD_CANALE_ORD, TO_V_DES_IND_SEDE_LEG, TO_V_DES_COM_SEDE_LEG, TO_V_DES_CAP_SEDE_LEG, TO_V_DES_IND_SPED, TO_V_DES_COM_SPED, CONCAT(ORD_V_COD_POS_ROWID_OWNER,' ', POS_V_COD_POSTN_TYPE), TO_V_COD_TELEFONO_REF, TO_V_COD_CELLULARE_REF"
