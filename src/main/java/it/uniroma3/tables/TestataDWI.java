...
public class TestataDWI extends Table {
	...
	protected String sqlTable() {
		return "SELECT TO_V_COD_ROWID_ORD,"
				...
				+ " END," 
				+ " TO_V_COD_NUM_CNT, "
				+ " CASE TO_V_COD_CANALE_ORD"
				+ "   WHEN '*ND' THEN NULL"
				+ "   WHEN 'N.D.' THEN NULL"
				+ "   ELSE TO_V_COD_CANALE_ORD"
				+ " END," 
				+ "TO_V_DES_IND_SEDE_LEG, TO_V_DES_COM_SEDE_LEG, TO_V_DES_CAP_SEDE_LEG, TO_V_DES_IND_SPED, TO_V_DES_COM_SPED, "
				+ "CONCAT(ORD_V_COD_POS_ROWID_OWNER,' ', "
				+ " CASE POS_V_COD_POSTN_TYPE"
				+ "   WHEN '*ND' THEN NULL"
				+ "   WHEN 'N.D.' THEN NULL"
				+ "   ELSE POS_V_COD_POSTN_TYPE"
				+ " END" 
				+ "),"
				+ " CASE TO_V_COD_TELEFONO_REF"
				+ "   WHEN '*ND' THEN NULL"
				+ "   WHEN 'N.D.' THEN NULL"
				+ "   ELSE TO_V_COD_TELEFONO_REF"
				+ " END," 
				+ " CASE TO_V_COD_CELLULARE_REF"
				+ "   WHEN '*ND' THEN NULL"
				+ "   WHEN 'N.D.' THEN NULL"
				+ "   ELSE TO_V_COD_CELLULARE_REF"
				+ " END" 
